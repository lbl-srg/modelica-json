...
class Class_specifierVisitor {
    ...
    visitClass_specifier(ctx) {
        ...
        if (ctx.long_class_specifier()) {
            var long_class_specifierVisitor = new Long_class_specifierVisitor.Long_class_specifierVisitor();
            ...
            var der_class_specifierVisitor = new Der_class_specifierVisitor.Der_class_specifierVisitor();
