...
class Simple_expressionVisitor {
    ...
    visitSimple_expression(ctx) {
        var logical_expressions = [];
        var logical_expression1 = null;
        var logical_expression2 = null;
        var logical_expression3 = null;

        if (ctx.logical_expression()) {
            var logical_expressionVisitor = new Logical_expressionVisitor.Logical_expressionVisitor();
