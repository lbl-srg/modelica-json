...
class Component_clause1Visitor {
  ...
  visitComponent_clause1 (ctx) {
    let type_prefix = null
    let type_specifier = null
    let component_declaration1 = null

    if (ctx.type_prefix()) {
      const type_prefixVisitor = new Type_prefixVisitor.Type_prefixVisitor()
    ...
    if (ctx.component_declaration1()) {
      const component_declaration1Visitor = new Component_declaration1Visitor.Component_declaration1Visitor()
