...
class ArgumentVisitor {
  ...
  visitArgument (ctx) {
    let element_modification_or_replaceable = null
    let element_redeclaration = null

    if (ctx.element_modification_or_replaceable()) {
      const element_modification_or_replaceableVisitor = new Element_modification_or_replaceableVisitor.Element_modification_or_replaceableVisitor()
    ...
    if (ctx.element_redeclaration()) {
      const element_redeclarationVisitor = new Element_redeclarationVisitor.Element_redeclarationVisitor()
