...
public class Function_arguments {
    ...
    public Function_arguments(Named_arguments named_arguments, Function_argument function_argument, For_indices for_indices, Function_arguments function_arguments) {
