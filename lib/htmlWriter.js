...
<h3>Internal connections</h3>
    ...
    <li>
    <code>
    <a href="#{{0.classLinkTarget}}">{{0.class}}</a>{{#0.connector}}.<a href="#{{0.portLinkTarget}}" >{{0.connector}}</a>{{/0.connector}}
    </code>
    &rarr;
    <code>
    <a href="#{{1.classLinkTarget}}">{{1.class}}</a>{{#1.connector}}.<a href="#{{1.portLinkTarget}}" >{{1.connector}}</a>{{/1.connector}}
    </code>
    </li>
    {{/connections}}
    </ol>
