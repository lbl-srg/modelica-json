...
function checkIfCdlElementaryBlockOrPackage (filePath) {
  ...
  name = name.toUpperCase().replaceAll('.', path.sep)
  const nameTokens = name.split(path.sep)
  ...
  if (nameTokens.length >= 3) {
    ...
    if (nameTokens.length === 5) {
      ...
      if ((singleFile && blockName5 === 'CONTROLS' && blockName4 === 'OBC' && blockName3 === 'CDL' && cdlPackages.includes(blockName2)) || 
        (!singleFile && blockName5 === 'BUILDINGS' && blockName4 === 'CONTROLS' && blockName3 === 'OBC' && blockName2 === 'CDL' && cdlPackages.includes(blockName))) {
        isElementaryBlockOrPackage = true
    ...
    if (nameTokens.length === 6) {
      ...
      if ((singleFile && blockName6 === 'BUILDINGS' && blockName5 === 'CONTROLS' && blockName4 === 'OBC' && blockName3 === 'CDL' && cdlPackages.includes(blockName2)) || 
        (!singleFile && blockName5 === 'BUILDINGS' && blockName4 === 'CONTROLS' && blockName3 === 'OBC' && blockName2 === 'CDL' && cdlPackages.includes(blockName))) {
        isElementaryBlockOrPackage = true
        ...
        (!singleFile && blockName6 === 'BUILDINGS' && blockName5 === 'CONTROLS' && blockName4 === 'OBC' && blockName3 === 'CDL' && cdlPackagesWithSources.includes(blockName2) && blockName === 'SOURCES')) { 
        isElementaryBlockOrPackage = true
      } else {
        return false
      }
    ...
    if (nameTokens.length >= 7) {
      ...
      if ((singleFile && blockName6 === 'BUILDINGS' && blockName5 === 'CONTROLS' && blockName4 === 'OBC' && blockName3 === 'CDL' && cdlPackages.includes(blockName2)) || 
        (!singleFile && blockName5 === 'BUILDINGS' && blockName4 === 'CONTROLS' && blockName3 === 'OBC' && blockName2 === 'CDL' && cdlPackages.includes(blockName))) {
        isElementaryBlockOrPackage = true
      } else if ((singleFile && blockName7 === 'BUILDINGS' && blockName6 === 'CONTROLS' && blockName5 === 'OBC' && blockName4 === 'CDL' && cdlPackagesWithSources.includes(blockName3) && blockName2 === 'SOURCES') ||
        (!singleFile && blockName6 === 'BUILDINGS' && blockName5 === 'CONTROLS' && blockName4 === 'OBC' && blockName3 === 'CDL' && cdlPackagesWithSources.includes(blockName2) && blockName === 'SOURCES')) {
        isElementaryBlockOrPackage = true
      } else {
        return false
