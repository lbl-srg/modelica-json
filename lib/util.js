...
function getFileNameInJsonOutput (json) {
  ...
  var within = getProperty(['within'], json)
  // Get the model name
  var shortClass = getProperty(
    ['final_class_definitions', 0, 'class_definition', 'class_specifier', 'short_class_specifier', 'identifier'], json)
  var shortName = shortClass !== null ? shortClass
    : getProperty(
      ['final_class_definitions', 0, 'class_definition', 'class_specifier', 'long_class_specifier', 'identifier'], json)
  if (shortName) {
