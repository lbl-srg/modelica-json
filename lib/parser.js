...
const ie = require('./instanceExtractor')
...
function getSimpleJson (moFile, parseMode, tempDir, parsedFile, outDir, prettyPrint) {
  ...
  // add instance extraction
  var instanceJson = ie.extractInstances(da)
  var instanceJsonPath = ut.getOutputFile(moFile, 'instances', tempDir)
  var instanceJsonOut = (prettyPrint === 'false') ? JSON.stringify(instanceJson) : JSON.stringify(instanceJson, null, 2)
  ut.writeFile(instanceJsonPath, instanceJsonOut)
