...
function exportJSON (data, outputFileName, outputFormat, parseMode) {
  if (outputFormat === 'html' || outputFormat === 'docx') {
    ...
    if (outputFormat === 'html') {
      ...
      ut.convertbase64(FullimgPathList)
      console.log('conversion done')
      ut.getbase64data(FullimgPathList).then(function(valuesdict) {
        console.log('file read')
        dicttobase64 = ut.toObject(valuesdict)
        ...
        outputFileName.forEach(function (element) {
          ...
          fs.readFile(input, 'utf-8', function (err, html) {
            ...
            $("img").each(function() {
              ...
              var new_src = dicttobase64[old_src]
