...
function getParametersAndBindings (jsons, classObject, fetchDoc = false, _instance, _bindings) {
  ...
  function handleSimpleAssignment (toReturn, component) {
    ...
    toReturn.parameters.push({
      ...
      unit: component.unit?.function_call?.name == "fill" // In case of array parameters
        ? component.unit.function_call.arguments[0].name
        : component.unit,
      displayUnit: component.displayUnit?.function_call?.name == "fill" // In case of array parameters
