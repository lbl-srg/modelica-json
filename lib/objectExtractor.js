...
function extractFromLongClassSpecifier (longClassSpecifier, fullMoFilePath, classPrefixes = null, within = null) {
  ...
  if ('identifier' in longClassSpecifier && longClassSpecifier.identifier !== undefined) {
    identifier = longClassSpecifier.identifier
    dictIdentifier.type = 'long_class_specifier'
  }
  if ('description_string' in longClassSpecifier && longClassSpecifier.description_string !== undefined && longClassSpecifier.description_string !== null) {
        ...
        if ('array_subscripts' in singleComponentList.declaration && singleComponentList.declaration.array_subscripts !== undefined) {
          ...
          singleComponentList.declaration.array_subscripts.forEach(subscript => {
            if ('expression' in subscript) {
              if (subscript.expression !== undefined && 'simple_expression' in subscript.expression) {
