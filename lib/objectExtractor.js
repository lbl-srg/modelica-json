...
function parseModification (mod, typeSpecifier = '') {
  ...
  if ('equal' in mod && mod.equal) {
    ...
    if (typeSpecifier === 'Real' || typeSpecifier === 'Integer' || typeSpecifier.endsWith('RealInput') || typeSpecifier.endsWith('RealOutput') || typeSpecifier.endsWith('IntegerInput') || typeSpecifier.endsWith('IntegerOutput')) {
      res.value = Number(value)
    } else if (typeSpecifier === 'Boolean' || typeSpecifier.endsWith('BooleanInput') || typeSpecifier.endsWith('BooleanOutput')) {
