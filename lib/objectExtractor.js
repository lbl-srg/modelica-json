  ...
  for (let i = 0; i < elementList.length; i++) {
    ...
    if ('component_clause' in element && element.component_clause !== undefined) {
      ...
      if ('constraining_clause' in element && element.constraining_clause !== undefined) {
        constraining_clause = element.constraining_clause
      }
      if ('replaceable' in componentClause && componentClause.replaceable !== undefined) {
        replaceable = componentClause.replaceable
      }
