  ...
  if (layer === 'icon') {
    ...
    if (transformation.rotation === undefined ||
      ...
      for (var i = 0; i < pointsRatio.x.length; i++) {
        // extent from bottom left to top right
        if (transformation.extent[0].x1 < transformation.extent[1].x1 &&
            transformation.extent[0].x2 < transformation.extent[1].x2) {
        ...
        } else if (transformation.extent[0].x1 < transformation.extent[1].x1 &&
                   transformation.extent[0].x2 > transformation.extent[1].x2) {
          x.push(pointsRatio.x[i] * width + transformation.extent[0].x1)
          y.push(pointsRatio.y[i] * height + transformation.extent[1].x2)
        // extent from top right to bottom left
        } else if (transformation.extent[0].x1 > transformation.extent[1].x1 &&
                   transformation.extent[0].x2 > transformation.extent[1].x2) {
          x.push(pointsRatio.x[i] * width + transformation.extent[1].x1)
          y.push(pointsRatio.y[i] * height + transformation.extent[1].x2)
        // extent from bottom right to top left
        } else {
          x.push(pointsRatio.x[i] * width + transformation.extent[1].x1)
          y.push(pointsRatio.y[i] * height + transformation.extent[0].x2)
        }
