...
function sizeOfFont (font, textString, boxHeight, boxWidth, obj, layer) {
  ...
  while (true) {
    ...
    if (layer === 'diagram' && obj.fontSize !== undefined) {
    ...
    if (layer === 'diagram' && obj.fontSize !== undefined) { break }
...
function interfaceSVG (obj, layerName) {
  ...
  // need to add text in diagram layer, like %name
