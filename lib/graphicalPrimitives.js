...
function graphicAttributeObj (keyNam, valStr) {
  if (keyNam === 'Line') { return lineAttributeObj(valStr) } else if (keyNam === 'Text') { return textAttributeObj(valStr) } else if (keyNam === 'Rectangle') { return rectangleAttributeObj(valStr) } else if (keyNam === 'Polygon') { return polygonAttributeObj(valStr) } else if (keyNam === 'Ellipse') { return ellipseAttributeObj(valStr) } else {
