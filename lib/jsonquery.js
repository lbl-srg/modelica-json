...
function longClassSpecifier (lonClaSpe) {
  ...
  return Object.assign(
    {'identifier': ident},
    {'description_string': (desStr === '') ? undefined : desStr},
...
function description (des) {
  ...
  return Object.assign(
    {'description_string': (strDes === '') ? undefined : strDes},
...
function equation (equ) {
  ...
  const desObj = des ? description(des) : undefined
  return Object.assign(
    {'assigment_equation': (assEqu && !ut.isEmptyObject(assEqu)) ? assigmentEquation(assEqu) : undefined},
...
function shortClassSpecifier (shoClaSpe) {
  ...
  return Object.assign(
    {'identifier': ident},
    {'short_class_specifier_value': val ? shortClassSpecifierValue(val) : undefined}
  )
}
...
function shortClassSpecifierValue (val) {
  ...
  return Object.assign(
    ...
    {'enum_list': enuLis ? enuArr : undefined}
  )
}
...
function derClassSpecifier (derClaSpe) {
  ...
  return Object.assign(
    {'identifier': ident},
    {'der_class_specifier_value': val ? valObj : undefined}
  )
}
