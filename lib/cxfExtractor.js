...
function getCxfSingleHtmlContent(graph, cxfBlockName, s231Ns, rdfNs, blockNode, imagePathUrlPrefix) {
  ...
  if (documentations.length === 1) {
    ...
    if (htmlDocumentation.includes('href=\\modelica://Buildings')) {
      ...
      // htmlDescription = htmlDescription.replaceAll('href=\\modelica://Buildings', 'src=https://raw.githubusercontent.com/lbl-srg/modelica-buildings/refs/tags/v11.0.0/Buildings')
      // console.log(htmlDescription)
    }
    if (htmlDocumentation.includes("<pre>")) {
      htmlDocumentation = htmlDocumentation.replaceAll('<pre>', '<pre style="background-color:white; font-size: 16px; padding-top: 4px; padding-bottom: 4px; color: maroon; font-family: \'Courier New\';">')
    }
    if (htmlDocumentation.includes("<code>")) {
      htmlDocumentation = htmlDocumentation.replaceAll('<code>', '<code style="background-color:white; font-size: 16px; padding-top: 4px; padding-bottom: 4px; color: maroon; font-family: \'Courier New\';">')
    }
  }
