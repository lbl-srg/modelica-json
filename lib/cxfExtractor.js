...
function findControlInstance (objects, directory, parentInstance = '') {
  ...
  // TODO: handle isControls in extends statements
  // if ('requiredReferences' in objects && objects.requiredReferences !== undefined ) {
  //   if ('extends_clause' in objects.requiredReferences && objects.requiredReferences.extends_clause !== undefined) {
  //     const extendsClause = objects.requiredReferences.extends_clause
  //     if ('classModifications' in extendsClause && extendsClause.classModifications !== undefined) {
  //       const classModifications = extendsClause.classModifications
  //       console.log(parseClassModification(classModifications, null, []))
  //     }
  //   }
  // }
