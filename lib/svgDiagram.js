...
function regularClassDiagram (indClass, interfaceClasses, regClasses) {
  ...
  if (classes.length > 0) {
    for (var t = 0; t < classes.length; t++) {
      ...
      console.log('Here =========== New classRectangles')
      console.log(classIns.classRectangles)
      console.log('whole classRectangles (before): -------')
      console.log(classRectangles)
      console.log('----------------------------')
      classRectangles = classRectangles.concat(classIns.classRectangles)
      console.log('whole classRectangles (after): -------')
      console.log(classRectangles)
      console.log('===========================================================')
