within FromModelica;
block SubControllerWithSemantics "Subsequence with class definition Semantics"
...
annotation (
  ...
  Icon(coordinateSystem(preserveAspectRatio=false), graphics={
    ...
    __cdl(semantic(metadataLanguage="Brick 1.3 text/turtle" "@prefix Brick: <https://brickschema.org/schema/Brick#> .
                                                           @prefix bldg: <urn:bldg/> . 
                                                           bldg:<cdl_instance_name> a Brick:Cooling_Coil . ")));
end SubControllerWithSemantics;
