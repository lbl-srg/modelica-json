within FromModelica;
block MyControllerWithExportAnnotation1 "My controller with export annotation in 1 CDL block"
  ...
  SubController subCon1 "Sub controller"
    annotation (Placement(transformation(extent={{-10,-50},{10,-30}})),
        __cdl(generatePointlist=true, export=true));
...
annotation (
  __cdl(propagate(instance="subCon2", generatePointlist=true, controlledDevice="My Device"), propagate(instance="subCon1", generatePointlist=false, controlledDevice="My Device2")),
...
end MyControllerWithExportAnnotation1;
