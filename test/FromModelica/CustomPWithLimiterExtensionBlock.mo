within FromModelica;
block CustomPWithLimiterExtensionBlock
  ...
  Custom.Gain.Block gain(final k=k) "Constant gain"
    annotation (__cdl(extensionBlock=true, hasFmuPath="Custom/Gain/Block.fmu"), Placement(transformation(extent={{-60,-50},{-40,-30}})));
...
end CustomPWithLimiterExtensionBlock;
