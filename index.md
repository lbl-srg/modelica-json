...
[modelica-json](https://github.com/lbl-srg/modelica-json) is a translator that parses the Modelica and Control Description Language (CDL) models to JSON (and other formats from JSON). 
